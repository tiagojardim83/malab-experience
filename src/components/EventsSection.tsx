              ...
              return (
                ...
                >
                  <div className="relative overflow-hidden aspect-[3/4] bg-muted">
                    {event.done && (
                      <div className="absolute top-0 left-0 z-20 w-[150%] origin-top-left -translate-x-[15%] translate-y-5 -rotate-45 bg-gradient-to-r from-black/95 to-black/80 backdrop-blur-sm py-2.5 shadow-xl">
